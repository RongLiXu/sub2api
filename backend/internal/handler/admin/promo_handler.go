...
type CreatePromoCodeRequest struct {
	...
	CreditBonusAmount float64 `json:"credit_bonus_amount" binding:"min=0"`
...
type UpdatePromoCodeRequest struct {
	...
	CreditBonusAmount *float64 `json:"credit_bonus_amount" binding:"omitempty,min=0"`
...
func (h *PromoHandler) Create(c *gin.Context) {
	...
	input := &service.CreatePromoCodeInput{
		...
		CreditBonusAmount: req.CreditBonusAmount,
		MaxUses:           req.MaxUses,
		Notes:             req.Notes,
	}
