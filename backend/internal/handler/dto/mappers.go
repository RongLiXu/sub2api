...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		SubscriptionCreditFallbackEnabled: g.SubscriptionCreditFallbackEnabled,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		ServiceTierMultiplier: l.ServiceTierMultiplier,
		...
		CreditCost:            l.CreditCost,
		BalanceCost:           l.BalanceCost,
		SubscriptionCost:      l.SubscriptionCost,
