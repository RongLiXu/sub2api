...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	snapshot := &APIKeyAuthSnapshot{
		...
		User: APIKeyAuthUserSnapshot{
			...
			CreditBalance:              apiKey.User.CreditBalance,
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			SubscriptionCreditFallbackEnabled: apiKey.Group.SubscriptionCreditFallbackEnabled,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	apiKey := &APIKey{
		...
		User: &User{
			...
			CreditBalance:              snapshot.User.CreditBalance,
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			SubscriptionCreditFallbackEnabled: snapshot.Group.SubscriptionCreditFallbackEnabled,
