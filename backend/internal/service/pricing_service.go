...
var (
	...
	// GPT-5.6 Sol：官方 Standard $5/$30/$0.50, Priority $10/$60/$1, Flex $2.50/$15/$0.25, CacheWrite $6.25
	openAIGPT56SolFallbackPricing = &LiteLLMModelPricing{
		InputCostPerToken:               5e-06,
		InputCostPerTokenPriority:       10e-06,
		InputCostPerTokenFlex:           2.5e-06,
		OutputCostPerToken:              30e-06,
		OutputCostPerTokenPriority:      60e-06,
		OutputCostPerTokenFlex:          15e-06,
	...
	// GPT-5.6 Terra：官方 Standard $2.50/$15/$0.25, Priority $5/$30/$0.50, Flex $1.25/$7.50/$0.125, CacheWrite $3.125
	...
	openAIGPT54NanoFallbackPricing = &LiteLLMModelPricing{
		...
		InputCostPerTokenFlex:       1e-07,
		OutputCostPerToken:          1.25e-06,
		OutputCostPerTokenFlex:      6.25e-07,
		CacheReadInputTokenCost:     2e-08,
		CacheReadInputTokenCostFlex: 1e-08,
		LiteLLMProvider:             "openai",
		Mode:                        "chat",
		SupportsPromptCaching:       true,
		SupportsServiceTier:         true,
...
// LiteLLMTokenPricingTier 表示按请求输入/输出 token 长度选择的整段单价。
// 边界为左闭右开；Max* 为 0 表示无上限。
type LiteLLMTokenPricingTier struct {
...
func (s *PricingService) parsePricingData(body []byte) (map[string]*LiteLLMModelPricing, error) {
	...
	for modelName, rawEntry := range rawData {
		...
		hasTokenPricing := entry.InputCostPerToken != nil || entry.OutputCostPerToken == nil && entry.OutputCostPerImage == nil && entry.OutputCostPerImageToken != nil
		...
		if entry.InputCostPerTokenFlex != nil {
			pricing.InputCostPerTokenFlex = *entry.InputCostPerTokenFlex
		}
		...
		if entry.OutputCostPerTokenFlex != nil {
			pricing.OutputCostPerTokenFlex = *entry.OutputCostPerTokenFlex
		}
		...
		if entry.CacheReadInputTokenCostFlex != nil {
			pricing.CacheReadInputTokenCostFlex = *entry.CacheReadInputTokenCostFlex
		}
...
func (s *PricingService) matchOpenAIModel(model string) *LiteLLMModelPricing {
	...
	// GPT-5.6 系列：按具体变体对齐官方定价（sol / terra / luna 价格不同）
	...
	// gpt-5.6-fingerling / gpt-5.6-garlic 等未定价变体回退到 sol
