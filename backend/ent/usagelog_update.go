...
func (_u *UsageLogUpdate) SetCreditCost(v float64) *UsageLogUpdate {
...
func (_u *UsageLogUpdate) SetNillableCreditCost(v *float64) *UsageLogUpdate {
	if v != nil {
		_u.SetCreditCost(*v)
	}
	return _u
...
func (_u *UsageLogUpdate) AddCreditCost(v float64) *UsageLogUpdate {
...
func (_u *UsageLogUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedCreditCost(); ok {
		_spec.AddField(usagelog.FieldCreditCost, field.TypeFloat64, value)
	}
...
// SetCreditCost sets the "credit_cost" field.
func (_u *UsageLogUpdateOne) SetCreditCost(v float64) *UsageLogUpdateOne {
	_u.mutation.ResetCreditCost()
	_u.mutation.SetCreditCost(v)
	return _u
}
...
// SetNillableCreditCost sets the "credit_cost" field if the given value is not nil.
func (_u *UsageLogUpdateOne) SetNillableCreditCost(v *float64) *UsageLogUpdateOne {
	if v != nil {
		_u.SetCreditCost(*v)
	}
	return _u
...
// AddCreditCost adds value to the "credit_cost" field.
func (_u *UsageLogUpdateOne) AddCreditCost(v float64) *UsageLogUpdateOne {
	_u.mutation.AddCreditCost(v)
	return _u
}
