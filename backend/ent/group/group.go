...
const (
	...
	// FieldSubscriptionCreditFallbackEnabled holds the string denoting the subscription_credit_fallback_enabled field in the database.
	FieldSubscriptionCreditFallbackEnabled = "subscription_credit_fallback_enabled"
...
var Columns = []string{
	...
	FieldSubscriptionCreditFallbackEnabled,
...
// BySubscriptionCreditFallbackEnabled orders the results by the subscription_credit_fallback_enabled field.
func BySubscriptionCreditFallbackEnabled(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSubscriptionCreditFallbackEnabled, opts...).ToFunc()
}
