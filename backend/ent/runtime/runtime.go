...
func init() {
	...
	// promocodeDescCreditBonusAmount is the schema descriptor for credit_bonus_amount field.
	promocodeDescCreditBonusAmount := promocodeFields[2].Descriptor()
	// promocode.DefaultCreditBonusAmount holds the default value on creation for the credit_bonus_amount field.
	promocode.DefaultCreditBonusAmount = promocodeDescCreditBonusAmount.Default.(float64)
	...
	// promocodeusageDescCreditBonusAmount is the schema descriptor for credit_bonus_amount field.
	promocodeusageDescCreditBonusAmount := promocodeusageFields[3].Descriptor()
	// promocodeusage.DefaultCreditBonusAmount holds the default value on creation for the credit_bonus_amount field.
	promocodeusage.DefaultCreditBonusAmount = promocodeusageDescCreditBonusAmount.Default.(float64)
	...
	// usagelogDescCreditCost is the schema descriptor for credit_cost field.
	usagelogDescCreditCost := usagelogFields[25].Descriptor()
	// usagelog.DefaultCreditCost holds the default value on creation for the credit_cost field.
	usagelog.DefaultCreditCost = usagelogDescCreditCost.Default.(float64)
	// usagelogDescBalanceCost is the schema descriptor for balance_cost field.
	usagelogDescBalanceCost := usagelogFields[26].Descriptor()
	// usagelog.DefaultBalanceCost holds the default value on creation for the balance_cost field.
	usagelog.DefaultBalanceCost = usagelogDescBalanceCost.Default.(float64)
	// usagelogDescSubscriptionCost is the schema descriptor for subscription_cost field.
	usagelogDescSubscriptionCost := usagelogFields[27].Descriptor()
	// usagelog.DefaultSubscriptionCost holds the default value on creation for the subscription_cost field.
	usagelog.DefaultSubscriptionCost = usagelogDescSubscriptionCost.Default.(float64)
	...
	userDescCreditBalance := userFields[4].Descriptor()
	// user.DefaultCreditBalance holds the default value on creation for the credit_balance field.
	user.DefaultCreditBalance = userDescCreditBalance.Default.(float64)
