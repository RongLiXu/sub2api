...
func CreditCost(v float64) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldEQ(FieldCreditCost, v))
}
...
func CreditCostEQ(v float64) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldEQ(FieldCreditCost, v))
}

// CreditCostNEQ applies the NEQ predicate on the "credit_cost" field.
func CreditCostNEQ(v float64) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldNEQ(FieldCreditCost, v))
}

// CreditCostIn applies the In predicate on the "credit_cost" field.
func CreditCostIn(vs ...float64) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldIn(FieldCreditCost, vs...))
}

// CreditCostNotIn applies the NotIn predicate on the "credit_cost" field.
func CreditCostNotIn(vs ...float64) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldNotIn(FieldCreditCost, vs...))
}

// CreditCostGT applies the GT predicate on the "credit_cost" field.
func CreditCostGT(v float64) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldGT(FieldCreditCost, v))
}

// CreditCostGTE applies the GTE predicate on the "credit_cost" field.
func CreditCostGTE(v float64) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldGTE(FieldCreditCost, v))
}

// CreditCostLT applies the LT predicate on the "credit_cost" field.
func CreditCostLT(v float64) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldLT(FieldCreditCost, v))
}

// CreditCostLTE applies the LTE predicate on the "credit_cost" field.
func CreditCostLTE(v float64) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldLTE(FieldCreditCost, v))
}
