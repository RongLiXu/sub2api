...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "subscription_credit_fallback_enabled", Type: field.TypeBool, Nullable: true},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "credit_cost", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		...
		{Name: "billing_source", Type: field.TypeString, Size: 32, Default: ""},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "credit_balance", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
