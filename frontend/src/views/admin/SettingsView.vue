	              ...
	              <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
	                ...
	                <div class="flex items-center gap-3">
	                  <span class="text-sm text-gray-600 dark:text-gray-300">
	                    {{ form.login_agreement_enabled ? t("admin.settings.loginAgreement.enabledStatus") : t("admin.settings.loginAgreement.disabledStatus") }}
	                  </span>
                    ...
                    <div class="mt-3">
                      <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">
                        ...
                        <textarea
                          ...
                          rows="8"
                          class="input font-mono text-sm"
                          :placeholder="t('admin.settings.loginAgreement.markdownPlaceholder')"
                        ></textarea>
                    </div>
                  </div>
                </div>
...
function defaultLoginAgreementDocuments(): LoginAgreementDocument[] {
  return [
    {
      id: "terms",
      title: t("admin.settings.loginAgreement.defaultTermsTitle"),
      content_md: "",
    },
    {
      id: "usage-policy",
      title: t("admin.settings.loginAgreement.defaultUsagePolicyTitle"),
      content_md: "",
    },
    {
      id: "supported-regions",
      title: t("admin.settings.loginAgreement.defaultSupportedRegionsTitle"),
      content_md: "",
    },
    {
      id: "service-specific-terms",
      title: t("admin.settings.loginAgreement.defaultServiceSpecificTermsTitle"),
      content_md: "",
    },
  ];
}
...
async function saveSettings() {
  ...
  try {
    ...
    if (form.login_agreement_enabled && normalizedLoginAgreementDocuments.length === 0) {
      appStore.showError(
        t("admin.settings.loginAgreement.validationMinOne"),
      );
      return;
    }
    ...
    if (emptyTitleDocument) {
      appStore.showError(
        t("admin.settings.loginAgreement.validationTitleRequired"),
      );
      return;
    }
    ...
    if (duplicateLoginAgreementDocumentId) {
      appStore.showError(
        t("admin.settings.loginAgreement.validationDuplicateRoute", {
          path: `/legal/${duplicateLoginAgreementDocumentId}`,
        }),
      );
      return;
    }
