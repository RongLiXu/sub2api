...
function applyConfig(config: ContentModerationConfig) {
  ...
  configForm.block_message = config.block_message || getDefaultBlockMessage()
...
async function saveConfig() {
  ...
  try {
    ...
    const payload: UpdateContentModerationConfig = {
      ...
      block_message: configForm.block_message || getDefaultBlockMessage(),
...
function getDefaultBlockMessage(): string {
