...
const loadPlans = async () => {
  ...
  try {
    ...
    appStore.showError(error?.message || t('admin.scheduledTests.failedToLoadPlans'))
  } finally {
    loading.value = false
  }
}
...
const handleCreate = async () => {
  ...
  try {
    ...
    appStore.showError(error?.message || t('admin.scheduledTests.failedToCreatePlan'))
  } finally {
...
const handleToggleEnabled = async (plan: ScheduledTestPlan, enabled: boolean) => {
  try {
    ...
    appStore.showError(error?.message || t('admin.scheduledTests.failedToUpdatePlan'))
  }
}
...
const handleDelete = async () => {
  ...
  try {
    ...
    appStore.showError(error?.message || t('admin.scheduledTests.failedToDeletePlan'))
  } finally {
    showDeleteConfirm.value = false
...
const toggleExpand = async (planId: number) => {
  ...
  try {
    ...
    appStore.showError(error?.message || t('admin.scheduledTests.failedToLoadResults'))
    results.value = []
  } finally {
