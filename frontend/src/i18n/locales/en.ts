export default {
  ...
  keyUsage: {
    ...
    deductionOrder: 'Deduction Order',
    walletDeductionOrder: 'Credit balance is used first, then account balance.',
    subscriptionDeductionOrder: 'After subscription quota is exhausted, configured fallback uses credit balance only and does not charge account balance.',
    // Usage stat cells
  ...
  modelsPage: {
    ...
    navHome: 'Home',
    title: 'Model Plaza',
    subtitle: 'Browse the platform standard pricing catalog with search, provider filters, context windows, and capability tags.',
    backHome: 'Back Home',
    refresh: 'Refresh',
    searchPlaceholder: 'Search model name, provider, or capability',
    providerFilter: 'Provider Filter',
    allProviders: 'All Providers',
    capabilityFilter: 'Capabilities',
    emptyTitle: 'No models matched the current filters',
    emptyDescription: 'Try clearing the provider or capability filters and search again.',
    ...
    imageTokenPrice: 'Image Token',
    imagePrice: 'Image Price',
    perImageUnit: 'image',
    stats: {
      totalModels: 'Models',
      totalModelsHint: 'All standard-priced models currently loaded from the pricing catalog.',
      providers: 'Providers',
      providersHint: 'Distinct upstream providers represented in the current catalog.',
      visionReady: 'Vision',
      visionReadyHint: 'Models that advertise image or visual understanding capability.',
      functionCallingReady: 'Tool Calling',
      functionCallingReadyHint: 'Models that expose structured function/tool calling support.',
    },
    modes: {
      chat: 'Chat',
  ...
  auth: {
    ...
    loginAgreement: {
      ...
      separator: ', ',
      noticeTitle: 'You need to accept the latest terms before continuing.',
      noticeDescription: 'Until accepted, email/password input and quick sign-in remain disabled.',
      openButton: 'View terms',
      dialogTitle: 'Terms Update Notice',
      dialogDescriptionWithDate: 'Our terms were updated on {date}. Please read and accept the documents below before continuing.',
      dialogDescriptionRecent: 'Our terms were updated recently. Please read and accept the documents below before continuing.',
      relatedDocuments: 'Related documents',
      reject: 'Decline',
      accept: 'Accept and continue',
      rejectedLoginWarning: 'You must accept the latest terms before using email/password or quick sign-in.',
      blockedLoginWarning: 'Please read and accept the latest terms before signing in.',
      rejectedRegisterWarning: 'You must accept the latest terms before registering or using quick sign-in.',
      blockedRegisterWarning: 'Please read and accept the latest terms before registering.',
    },
    linuxdo: {
  ...
  public: {
    legalDocument: {
      ...
      notFoundDescription: 'This policy document does not exist or has been removed by the administrator.',
      sectionLabel: 'Login agreement',
  ...
  usage: {
    ...
    billingSourceCreditBalance: 'Credit Balance',
    billingSourceBalance: 'Balance',
    billingSourceMixed: 'Credit + Balance',
    billingSourceSubscriptionCreditFallback: 'Subscription Credit Fallback',
  ...
  redeem: {
    ...
    currentCreditBalance: 'Credit Balance',
    ...
    creditBalanceAddedRedeem: 'Credit Balance Added (Redeem)',
    ...
    viewCreditLedger: 'View Credit Ledger',
    creditLedgerTitle: 'Credit Balance Ledger',
    noCreditLedger: 'No credit balance records yet',
    balanceAfter: 'Balance After',
    creditEntryTypes: {
      admin_set: 'Admin Set',
      admin_add: 'Admin Grant',
      admin_subtract: 'Admin Deduct',
      usage_deduct: 'Usage Deduct',
      redeem_grant: 'Redeem Grant',
  ...
  admin: {
    ...
    users: {
      ...
      creditLedgerTitle: 'Credit Balance Ledger',
      noCreditLedger: 'No credit balance records found',
      balanceAfter: 'Balance After',
      operationSet: 'Set',
      operationAdd: 'Add',
    ...
    promo: {
      ...
      columns: {
        ...
        creditBonusAmount: 'Credit Bonus Amount',
        maxUses: 'Max Uses',
        usedCount: 'Used',
        usage: 'Usage',
        status: 'Status',
    ...
    settings: {
      ...
      loginAgreement: {
        ...
        description: 'Control whether the login page requires users to read and accept service terms, privacy policies, or other Markdown documents first.',
        enabledStatus: 'Enabled',
        disabledStatus: 'Disabled',
        displayMode: 'Display mode',
        modal: 'Modal',
        checkbox: 'Checkbox',
        checkboxHint: 'The checkbox appears below the login button and gates all login actions until selected.',
        modalHint: 'The modal opens on the login page and gates all login actions until accepted.',
        updatedDate: 'Updated date',
        updatedDateHint: 'Changing the date or document content requires fresh consent.',
        documentsTitle: 'Agreement documents',
        documentsHint: 'Document titles are customizable and content is stored as Markdown. Suggested defaults include Terms of Service, Usage Policy, Supported Countries and Regions, and Service-Specific Terms.',
        ...
        defaultTermsTitle: 'Terms of Service',
        defaultUsagePolicyTitle: 'Usage Policy',
        defaultSupportedRegionsTitle: 'Supported Countries and Regions',
        defaultServiceSpecificTermsTitle: 'Service-Specific Terms',
        validationMinOne: 'At least one document is required when login agreement is enabled.',
        validationTitleRequired: 'Login agreement document title cannot be empty.',
        validationDuplicateRoute: 'Login agreement document routes cannot be duplicated: {path}',
      },
  ...
  userSubscriptions: {
    ...
    creditFallbackHint: 'After subscription quota is exhausted, global or group settings may continue billing credit balance. If credit balance is insufficient, account balance will not be charged automatically.'
  },
  ...
  payment: {
    ...
    currentCreditBalance: 'Current Credit Balance',
    walletDeductionOrder: 'Deduction order: credit balance first, then account balance.',
    subscriptionCreditFallbackHint: 'After subscription quota is exhausted, global or group settings may continue billing credit balance. If credit balance is insufficient, account balance will not be charged automatically.',
