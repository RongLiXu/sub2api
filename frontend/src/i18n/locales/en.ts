export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportAccountPlatformMismatch:
        'Imported account platforms do not match the selected groups. Expected platform: {expected_platform}; mismatched accounts: {mismatch_count}. Examples: {examples}',
      ...
      clone: 'Clone',
      cloneName: '{name} Copy',
      clonePrompt: 'Enter cloned account name',
      cloneSuccess: 'Account cloned successfully',
      cloneFailed: 'Failed to clone account',
