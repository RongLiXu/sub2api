export default {
  ...
  keyUsage: {
    ...
    deductionOrder: '扣款顺序',
    walletDeductionOrder: '优先使用信用额度，信用额度不足时再扣账户余额。',
    subscriptionDeductionOrder: '套餐额度用完后按配置仅使用信用额度兜底，不会自动扣账户余额。',
    // Usage stat cells
    todayRequests: '今日请求',
  ...
  auth: {
    ...
    loginAgreement: {
      ...
      openButton: '查看条款',
      dialogTitle: '条款更新通知',
      dialogDescriptionWithDate: '我们的服务条款已于 {date} 更新。在继续使用服务之前，请仔细阅读并同意以下条款。',
      dialogDescriptionRecent: '我们的服务条款近期已更新。在继续使用服务之前，请仔细阅读并同意以下条款。',
      relatedDocuments: '相关文档',
      reject: '拒绝',
      accept: '同意并继续',
      rejectedLoginWarning: '未同意最新条款前，无法输入账号密码或使用快捷登录。',
      blockedLoginWarning: '请先阅读并同意最新条款后再登录。',
      rejectedRegisterWarning: '未同意最新条款前，无法注册或使用快捷登录。',
      blockedRegisterWarning: '请先阅读并同意最新条款后再注册。',
    },
    linuxdo: {
  ...
  usage: {
    ...
    accountBilled: '账号计费',
    billingSource: '扣费来源',
    billingSourceSubscription: '订阅套餐',
    billingSourceCreditBalance: '信用额度',
    billingSourceBalance: '账户余额',
    billingSourceMixed: '信用额度 + 账户余额',
    billingSourceSubscriptionCreditFallback: '订阅超限信用兜底',
    creditCost: '信用额度扣费',
    balanceCost: '余额扣费',
    subscriptionCost: '订阅扣费',
  ...
  redeem: {
    ...
    creditBalanceAddedRedeem: '信用额度发放（兑换）',
    ...
    viewCreditLedger: '查看信用流水',
    creditLedgerTitle: '信用额度流水',
    noCreditLedger: '暂无信用额度流水',
    balanceAfter: '变动后余额',
    creditEntryTypes: {
      admin_set: '管理员设置',
      admin_add: '管理员发放',
  ...
  admin: {
    ...
    users: {
      ...
      adjustCreditBalance: '调整信用额度',
      currentCreditBalance: '当前信用额度',
      creditOperation: '操作类型',
      creditAmount: '信用额度金额',
      creditLedgerTitle: '信用额度流水',
      noCreditLedger: '暂无信用额度流水',
      balanceAfter: '变动后余额',
    ...
    settings: {
      ...
      loginAgreement: {
        ...
        markdownPlaceholder: '在这里填写正式 Markdown 内容。',
        defaultTermsTitle: '服务条款',
        defaultUsagePolicyTitle: '使用政策',
        defaultSupportedRegionsTitle: '支持的国家和地区',
        defaultServiceSpecificTermsTitle: '服务特定条款',
        validationMinOne: '启用登录条款确认时，至少需要保留一份文档。',
        validationTitleRequired: '登录条款文档名称不能为空。',
        validationDuplicateRoute: '登录条款文档路由不能重复：{path}',
      },
  ...
  userSubscriptions: {
    ...
    creditFallbackHint: '套餐额度用完后，将按全局/分组配置使用信用额度继续扣费；如果信用额度不足，不会自动扣账户余额。'
  },
  ...
  payment: {
    ...
    currentCreditBalance: '当前信用额度',
    walletDeductionOrder: '消费顺序：优先使用信用额度，信用额度不足时再扣账户余额。',
    subscriptionCreditFallbackHint: '套餐额度用完后，将按全局/分组配置使用信用额度继续扣费；如果信用额度不足，不会自动扣账户余额。',
    quickAmounts: '快捷金额',
    customAmount: '自定义金额',
    enterAmount: '输入金额',
    paymentMethod: '支付方式',
