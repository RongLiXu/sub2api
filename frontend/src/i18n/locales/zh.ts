export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportWarning: '导入将创建新上游账号与代理；可选导入目标分组，未选择时保持不绑定分组。',
      dataImportFile: '数据文件',
      ...
      dataImportAccountPlatformMismatch:
        '导入文件中的上游账号平台与所选分组不匹配。期望平台：{expected_platform}，不匹配上游账号：{mismatch_count}。示例：{examples}',
